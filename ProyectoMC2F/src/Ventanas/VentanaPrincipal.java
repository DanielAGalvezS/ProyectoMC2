...
public static int ingresarNodoOrigen(String nodoOrige, String noExiste,int tope){
 ...
 jmapa.setIcon(new ImageIcon(scaledInstance));  
    ...
    private void initComponents() {
        ...
        jmapa.setBackground(new java.awt.Color(204, 255, 204));
        jmapa.setForeground(new java.awt.Color(204, 255, 204));
        jPanel1.add(jmapa);
        ...
        jButton1.setText("Borrar camino mas corto");
        ...
        jButton1.setBounds(30, 400, 150, 50);
        ...
        jButton14.setBounds(30, 100, 60, 36);
        ...
        jPanel3.getAccessibleContext().setAccessibleName("Distancia recorrida");
        ...
        jMenuItem10.setText("Eliminar Vértice");
 ...
 if(Eliminar<=tope && Eliminar>=0 && tope>0){
    ...
    private void jMenuItem13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem13ActionPerformed
        if(tope>=2){
            permanente =  ingresarNodoOrigen("Ingrese vertice de Origen","Vertice Origen No existe",tope);// hacemos el llamano de la funcion
            nodoFin =  ingresarNodoOrigen("Ingrese vértice Final","Vertice final No existe",tope);
            Algoritmo_Dijkstra Dijkstra = new Algoritmo_Dijkstra(arboles,tope,permanente,nodoFin);
            Dijkstra.dijkstra();
            jtacumulado.setText(""+Dijkstra.getAcumulado());
        }
